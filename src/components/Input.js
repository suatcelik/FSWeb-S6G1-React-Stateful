    ...
    <div className="widget-input container">
      ...
      <div>
        <input
          ...
          id="input"
          type="text"
          // fonksiyonum argümansız çalışıyorsa
          onChange={inputuDeğiştir}

          // fonksiyonum argümanlı çalışıyorsa
          // Örneğin onChange={() => biFonksiyon("biData")}

          // fonksiyonumun bir event yakalaması gerekiyorsa
          // onChange={(e) => inputuDeğiştir(e.target.value)}
        />{" "}
        {/* ADIM 6 */}
